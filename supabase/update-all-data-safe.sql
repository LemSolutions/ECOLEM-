-- ═══════════════════════════════════════════════════════════════════════════
-- LEM CERAMIC SYSTEM - SCRIPT AGGIORNAMENTO DATI COMPLETO (VERSIONE SICURA)
-- ═══════════════════════════════════════════════════════════════════════════
-- 
-- ISTRUZIONI:
...
-- 3. Clicca "Run"
--
-- NOTA: Questo script aggiorna i dati esistenti cancellando e reinserendo
--       solo i record specificati. I dati aggiunti manualmente dalla dashboard
--       che non sono in questo script verranno mantenuti.
--
-- ═══════════════════════════════════════════════════════════════════════════
...
-- Elimina solo i servizi che vogliamo aggiornare
...
-- Inserisci i servizi aggiornati
...
-- Elimina solo i prodotti che vogliamo aggiornare
...
-- Inserisci i prodotti aggiornati - STAMPANTI
...
-- Elimina solo i post del blog che vogliamo aggiornare
...
-- Inserisci i post del blog aggiornati
