...
-- 3. Clicca "Run"
--
-- NOTA: Questo script cancella i dati esistenti e inserisce i nuovi
--
-- ═══════════════════════════════════════════════════════════════════════════

-- Pulisci dati esistenti (mantieni le tabelle)
...
INSERT INTO products (name, description, short_description, price, price_type, category, features, is_featured, is_active, sort_order) VALUES
...
SELECT 'Dati inseriti con successo!' AS status;
